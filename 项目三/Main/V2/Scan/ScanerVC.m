...
- (void)viewDidLoad {
    [super viewDidLoad];
    _scanerView = [[ScanerView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)];
    _loadingView = [[UIView alloc] initWithFrame:CGRectMake(kScreenWidth/2-20, kScreenHeight/2-20, 40, 40)];
